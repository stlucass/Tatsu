...
<body id="top">
  ...
  ?>
    ...
    <header class="header active" data-header>
        <div class="container">
            ...
            <a href="#hero" class="logo">
                <img src="./assets/images/logo.png" alt="unigine hero">
            </a>
    ...
    <main>
        <article>
            <!-- HERO -->
            <div class="hero has-before" id="hero">
                <div class="container">
                    ...
                    <h1 class="h1 title hero-title">SABORES DO JAPÃO<br>A CADA MORDIDA!</h1>
                    ...
                    <div class="hero-banner">
                        ...
                        <img src="./assets/images/sushi-banner-bg.jpg" alt="" class="hero-banner-bg">
                    </div>
