...
<body>
    ...
    ?>
    <!-- FIM PHP -->
    <a href="delivery.php" class="btnvoltar" data-btn>Voltar</a>
    <div class="container">
        <form action="">
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <div class="inputBox">
                        ...
                        <img src="./assets/images/card_img.png" alt="imagem cartões">
                    </div>
                    <div class="inputBox">
            ...
            <input type="submit" value="Finalizar a compra" class="sunmit-btn">
        </form>
    </div>
</body>
